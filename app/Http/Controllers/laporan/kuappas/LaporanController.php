...
namespace App\Http\Controllers\laporan\kuappas;
...
class LaporanController extends Controller
{
    ...
    public function __construct(DashboardService $dashboard_service)
    {
        ...
        $this->tahapan = Tahapan::whereNama(\App\Enum\Tahapan::KUA_PPAS)->first();
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('laporan.kuappas.index', compact('village',
            'villages',
            'district',
            'districts',
            'users'));
...
//        dd($request->all());
        ...
        return view('laporan.kuappas.preview', compact('items', 'district', 'village', 'user'));
    }
    ...
    public function show(Request $request)
    {
        ...
        $items = $items->toJson();
        return view('laporan.kuappas._table', compact('items', 'anggaran'));
    }
...
//            $user = User::find($user_id);
        ...
        $writer->openToBrowser('Laporan KUA PPAS.xlsx'); // stream data directly to the browser

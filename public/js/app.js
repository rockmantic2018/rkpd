...
// Vue.component('management-menu', require('./components/admin/ManagementMenu'));
// Vue.component('toggle-permission-menu', require('./components/admin/TogglePermissionMenu'));

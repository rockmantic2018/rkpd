<div class="form-group m-form__group {{ $errors->has('lokasi_kegiatan') ? 'has-danger' : '' }}">
    ...
    <select class="form-control m-select2" id="lokasi_kegiatan_awal"
            name="lokasi_kegiatan" {{ (auth()->user()->hasRole(\App\Enum\Roles::KECAMATAN) == true ? 'disabled' : '') }}>
    ...
    @if((auth()->user()->hasRole(\App\Enum\Roles::KECAMATAN) == true))
        <input type="hidden" name="lokasi_kegiatan" value="3">
    @endif
</div>
...
<div class="form-group row" id="flag_kecamatan_awal">
    ...
    <div class="col-6">
        <div class="form-group m-form__group">
            ...
            <select class="form-control m-select2" id="select_district_2" name="kecamatan" disabled>
        ...
        <div class="form-group m-form__group">
            ...
            <select class="form-control m-select2" id="select_village" name="desa">
                @foreach($district->villages as $village)
                    <option {{ old('desa') }} value="{{ $village->id }}">{{ $village->name }}</option>
                @endforeach
            </select>
        </div>
    </div>

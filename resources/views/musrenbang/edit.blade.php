            ...
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{ route($type.'index') }}" class="m-nav__link">
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Musrenbang Desa</h3>
                    </div>
                </div>
            </div>
            <div class="m-portlet__body">
                ...
                <form class="m-form m-form--fit m-form--label-align-right"  method="POST" enctype="multipart/form-data"
                      action="{{ route($type.'update', [$item->id]) }}">
                    {{ method_field('PUT')}}
                    @include('desa.musrenbang._form')
                </form>

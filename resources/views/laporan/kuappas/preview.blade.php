        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="{{ route('laporan.kuappas') }}" class="m-nav__link">
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                ...
                <div class="pull-right">
                    <form action="{{ route('export.excel.kuappas') }}" style="display:inline;" method="POST">
                        {{ csrf_field() }}
                    ...
                    <a href="{{ route('laporan.kuappas') }}" class="btn m-btn--pill m-btn--air btn-secondary">Kembali</a>
                </div>
                <br><br><br>
                ...
                <iframe frameborder="0" width="100%" height="500" name="form_laporan"
                        src="{{ route('laporan.kuappas.preview', ['district' => $district, 'village' => $village, 'user' => $user]) }}"></iframe>

        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Laporan Rancangan Awal</h3>
                    </div>
                </div>
            </div>
            <div class="m-portlet__body">
                ...
                <!-- <div class="pull-right">
                    <form action="{{ route('export.excel.awal') }}" style="display:inline;" method="POST">
                        {{ csrf_field() }}
                ...
                <iframe frameborder="0" width="100%" height="500" name="form_laporan"
                        src="{{ route('laporan.awal.preview', ['district' => $district, 'village' => $village, 'user' => $user]) }}"></iframe>

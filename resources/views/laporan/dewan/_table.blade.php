...
<head>
    ...
    <title>LAPORAN POKOK PIKIRAN DEWAN</title>
    <style>
        @page {
            margin: 0px;
            width: 330mm;
...
<table width="1400" height="550" border="0" cellspacing="0" cellpadding="4" align="center" class="wrapper">
    ...
    <tr>
        <td colspan="3">
            <h2>HASIL POKOK PIKIRAN DEWAN<br/>
        ...
        <td colspan="3">
            <table width="100%" border="0" cellspacing="0" cellpadding="3" class="data_table">
                ...
                <tr style="border-bottom:#999 solid 2px;">
                    ...
                    <th rowspan="3" width="100">Anggota Dewan</th>
                </tr>
                ...
                @foreach (json_decode($items) as $idx => $anggaran)
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">{{ $anggaran->user->nama_lengkap }}</td>
                    </tr>
                @endforeach

...
@section('content')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">Program</h3>
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Daftar Program</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="{{ route('program.create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                ...
                <table class="m-datatable" id="html_table" width="100%">
                    ...
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td>
                                {{ $item->bidangUrusan ? $item->bidangUrusan->nama : '' }}
                            </td>
                            <td>
                                @include('global.table_action_admin', [
                                    'action' => route('program.destroy', ['id' => $item->id]),
                                    'url'    => route('program.edit', ['id' => $item->id]),
                                    'id'     => $item->id
                                ])
                            </td>
                        </tr>

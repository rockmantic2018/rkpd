            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Daftar Data Indikator Sasaran</h3>
                    </div>
                </div>
            </div>
            ...
            <!--begin: Search Form -->
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="{{ route('indikator-sasaran.create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                ...
                <thead>
                    ...
                    @forelse($items as $item)
                        <tr>
                            <td>
                                {{ $item->sasaran ? $item->sasaran->nama : ''}}
                            </td>
                            <td>
                                {{ $item->nama }}
                            </td>
                            <td>
                                @include('global.table_action_admin', [
                                    'action' => route('indikator-sasaran.destroy', ['id' => $item->id]),
                                    'url'    => route('indikator-sasaran.edit', ['id' => $item->id]),
                                    'id'     => $item->id
                                ])
                            </td>
                        </tr>

...
@section('content')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">OPD Kegiatan</h3>
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">OPD : {{ $opd->nama }}</h3>
                    </div>
                </div>
            </div>
            ...
            <!--begin: Search Form -->
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-5 order-1 order-xl-2 m--align-right">
                            <a href="{{ route('opd.index') }}" class="btn btn-default m-btn--hover-info m-btn m-btn--icon m-btn--air m-btn--pill">
                                <span><i class="la la-backward"></i>
                                    <span>Kembali</span>
                                </span>
                            </a>
                            <a href="{{ route('opd.opd-kegiatan.create', $id) }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                ...
                <table class="m-datatable" id="html_table" width="100%">
                    ...
                    @foreach($items as $item)
                        <tr>
                            <td>
                                {{ $item->kegiatan ? $item->kegiatan->nama : '-' }}
                            </td>
                            <td>
                                @include('global.table_action_admin', [
                                    'action' => route('opd.opd-kegiatan.destroy', ['id' => $item->id, 'opd_id' => $id]),
                                    'url'    => route('opd.opd-kegiatan.edit', ['id' => $item->id, 'opd_id' => $id]),
                                    'id'     => $item->id
                                ])
                            </td>
                        </tr>

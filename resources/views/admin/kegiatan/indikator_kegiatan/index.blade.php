            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Kegiatan: {{ $kegiatan->nama }}</h3>
                    </div>
                </div>
            </div>
            ...
            <!--begin: Search Form -->
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-5 order-1 order-xl-2 m--align-right">
                            <a href="{{ route('kegiatan.index') }}" class="btn btn-default m-btn--hover-info m-btn m-btn--icon m-btn--air m-btn--pill">
                                <span><i class="la la-backward"></i>
                                    <span>Kembali</span>
                                </span>
                            </a>
                            <a href="{{ route('kegiatan.indikator-kegiatan.create', $id) }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                ...
                <table class="m-datatable" id="html_table" width="100%">
                    ...
                    <tr>
                        ...
                        <th title="Analisis Standar Biaya">
                    ...
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td>
                                {{ format_money($item->asb, '0', '') }}
                            </td>
                            <td>
                                @include('global.table_action_admin', [
                                    'action' => route('kegiatan.indikator-kegiatan.destroy', ['id' => $item->id, 'kegiatanId' => $id]),
                                    'url'    => route('kegiatan.indikator-kegiatan.edit', ['id' => $item->id, 'kegiatanId' => $id]),
                                    'id'     => $item->id
                                ])
                            </td>
                        </tr>

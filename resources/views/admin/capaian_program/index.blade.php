...
@section('content')
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">Capaian Program</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <span class="m-nav__link-text">Capaian Program</span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="m-portlet__head">
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Daftar Data Capaian Program</h3>
                    </div>
                </div>
            </div>
            ...
            <!--begin: Search Form -->
                <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            <a href="{{ route('capaian-program.create') }}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                ...
                <table class="m-datatable" id="html_table" width="100%">
                    ...
                    @foreach($items as $item)
                        <tr>
                            <td>
                                {{ $item->program ? $item->program->nama : '' }}
                            </td>
                            <td>
                            ...
                            <td>
                                @include('global.table_action_admin', [
                                    'action' => route('capaian-program.destroy', ['id' => $item->id]),
                                    'url'    => route('capaian-program.edit', ['id' => $item->id]),
                                    'id'     => $item->id
                                ])
                            </td>
                        </tr>
